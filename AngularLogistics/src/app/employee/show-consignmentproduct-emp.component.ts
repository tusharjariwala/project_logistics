...
@Component({
  selector: 'app-show-consignmentproduct-emp',
  templateUrl: './show-consignmentproduct-emp.component.html',
  encapsulation:ViewEncapsulation.None,
})
export class ShowConsignmentproductEmpComponent implements OnInit {
...
consignmentproduct_id_pk=0;
  ...
  constructor(public service:restapiemployee,private route:ActivatedRoute,private router:Router) { }
  ...
  AddConsignmentproduct(form:NgForm)
  {
    ...
    this.service.AddConsignmentproduct(this.consignmentproductData).subscribe(res=>{
      ...
      if(this.insertRespone.result=="success")
      {
        ...
        this.router.navigate(['/admin/show-consingmentproduct-emp'],{relativeTo:this.route});
      }
      else{
        console.log(res);
      }
