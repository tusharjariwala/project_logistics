...
@Component({
  selector: 'app-add-transportmanagement-emp',
  templateUrl: './add-transportmanagement-emp.component.html',
  encapsulation:ViewEncapsulation.None,
})
export class AddTransportmanagementEmpComponent implements OnInit {
...
transport_id_pk=0;
  ...
  AddTransport(form:NgForm)
  {
    ...
    this.service.AddTransport(this.transportData).subscribe(res=>{
      ...
      {
        this.resetForm(form);
        this.router.navigate(['/employee/show-transportmanagement-emp'],{relativeTo:this.route});
      }
      else{
        console.log(res);
      }
