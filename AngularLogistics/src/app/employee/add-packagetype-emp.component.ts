...
@Component({
  selector: 'app-add-packagetype-emp',
  templateUrl: './add-packagetype-emp.component.html',
  encapsulation:ViewEncapsulation.None,
})
export class AddPackagetypeEmpComponent implements OnInit {
...
packagetype_id_pk=0;
  ...
  AddPackagetype(form:NgForm)
  {
    ...
    this.service.AddPackagetype(this.packagetypeData).subscribe(res=>{
      ...
      {
        this.resetForm(form);
        this.router.navigate(['/employee/show-packagetype-emp'],{relativeTo:this.route});
      }
      else{
        console.log(res);
      }
