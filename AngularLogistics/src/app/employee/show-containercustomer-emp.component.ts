...
@Component({
  selector: 'app-show-containercustomer-emp',
  templateUrl: './show-containercustomer-emp.component.html',
  encapsulation:ViewEncapsulation.None,
})
export class ShowContainercustomerEmpComponent implements OnInit {
...
container_customerid_pk=0;
  ...
  AddContainerCustomer(form:NgForm)
  {
    ...
    this.service.AddContainerCustomer(this.containercustomerData).subscribe(res=>{
      ...
      {
        // this.resetForm(form);
        this.router.navigate(['/admin/show-containercustomer-emp'],{relativeTo:this.route});
      }
      else{
        console.log(res);
      }
