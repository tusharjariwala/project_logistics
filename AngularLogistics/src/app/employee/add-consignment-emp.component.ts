...
@Component({
  selector: 'app-add-consignment-emp',
  templateUrl: './add-consignment-emp.component.html',
  encapsulation:ViewEncapsulation.None,
})
export class AddConsignmentEmpComponent implements OnInit {
...
consignment_id_pk=0;
  ...
  AddConsignment(form:NgForm)
  {
    ...
    this.consignmentData.employee_id_fk=1;
   
    this.consignmentData.tracking_id= Math.floor((Math.random()*100000));
    ...
    this.service.AddConsignment(this.consignmentData).subscribe(res=>{
      ...
      {
        this.resetForm(form);
        this.router.navigate(['/employee/add-consingmentproduct-emp',this.insertRespone.data],{relativeTo:this.route});
      }
      else{
        console.log(res);
      }
