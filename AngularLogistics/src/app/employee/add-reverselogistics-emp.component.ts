...
@Component({
  selector: 'app-add-reverselogistics-emp',
  templateUrl: './add-reverselogistics-emp.component.html',
  encapsulation:ViewEncapsulation.None,
})
export class AddReverselogisticsEmpComponent implements OnInit {
...
reverselogistics_id_pk=0;
  ...
  AddReverseLogistics(form:NgForm)
  {
    ...
    this.service.AddReverseLogistics(this.reverselogisticData).subscribe(res=>{
      ...
      {
        this.resetForm(form);
        this.router.navigate(['/employee/show-reverselogistics-emp'],{relativeTo:this.route});
      }
      else{
        console.log(res);
      }
