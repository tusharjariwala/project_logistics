...
@Component({
  selector: 'app-add-vehicle-emp',
  templateUrl: './add-vehicle-emp.component.html',
  encapsulation:ViewEncapsulation.None,
})
export class AddVehicleEmpComponent implements OnInit {
...
vehicle_id_pk=0;
  ...
  AddVehicle(form:NgForm)
  {
    ...
    this.service.AddVehicle(this.vehicleData).subscribe(res=>{
      ...
      {
        this.resetForm(form);
        this.router.navigate(['/employee/show-vehicle-emp'],{relativeTo:this.route});
      }
      else{
        console.log(res);
      }
